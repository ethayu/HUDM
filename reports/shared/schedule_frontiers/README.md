...
```bash
MPLCONFIGDIR=/tmp/mwm-mpl .venv/bin/python reports/shared/schedule_frontiers/generate.py
```
...
`schedule_analysis.py` groups equivalent rules and filters schedules using exact empirical breakpoints. Display lines interpolate; numerical comparisons do not.
