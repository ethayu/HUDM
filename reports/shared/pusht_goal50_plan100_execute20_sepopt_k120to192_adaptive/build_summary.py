"""Build summaries for PushT goal50 sweeps on the sepopt K48-192 checkpoint,
restricted to the K120-192 range. Mirrors the reacher/ogb_cube goal50
reports, but PushT has no full K48-192 adaptive series (that sweep was
cancelled before launch) -- only K120-192 data exists here.
...
K120SLICE_SOURCE_DIR = Path(
    ...
    "release20260728_pusht_goal50_k120to192slice_sepopt_all_fidelity_schedules"
)
DENSE_LEVELS_SOURCE_DIR = Path(
    "/vast/projects/dineshj/lab/aurora/reports/research/"
    "release20260728_pusht_goal50_dense_checkpoint_k120to192_levels"
)
