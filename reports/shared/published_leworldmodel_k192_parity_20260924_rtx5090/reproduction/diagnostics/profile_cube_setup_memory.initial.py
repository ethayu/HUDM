...
receipt = {'diagnostic_only': True, 'completed_at': datetime.datetime.now(datetime.timezone.utc).isoformat(),
           'device': 'cpu', 'environment_created': False, 'rollouts_executed': False,
           ...
           'rng_state_unchanged': True, 'samples': samples,
...
(ROOT / 'cube_allocator_profile_receipt.json').write_text(json.dumps(receipt, indent=2) + '\n')
