...
class PreJEPAStableWMAdapter:
    ...
    def component_groups(self) -> dict[str, ComponentGroup]:
        return {
            "latent_producer": ComponentGroup(name="latent_producer", components=("backbone",), latent_producer=True),
    ...
    def default_policy(self) -> ComponentPolicy:
        return ComponentPolicy(shared=("latent_producer",), per_level=("transition",), reconstructor=("reconstructor",))
    ...
    def resolve_spec(
        ...
        *,
        ...
        raise NotImplementedError("PreJEPA/DINO-WM MWM support requires an explicit Stable-WM training recipe artifact.")
...
__all__ = ["PreJEPAStableWMAdapter"]
