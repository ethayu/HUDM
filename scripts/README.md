...
Scripts are external consumers of the MWM library. They should use public root
CLIs or canonical public `mwm.*` modules, never private helpers, retired
compatibility modules, or root CLI modules as Python imports.
