"""Build data/ summaries for the completed TwoRoom goal25 sweeps on /vast/projects:
...
- k96to192_adaptive_summary.json (418/418): runs 02-26, adaptive schedules on
  ...
  NOT the sepopt checkpoint. Slurm array 8634466, config
  configs/research/release20260728_dense_tworoom_goal25_k96to192_all_fidelity_schedules.yaml.
...
- dense_checkpoint_individual_levels_summary.json (154/154): the sepopt
  ...
  Slurm array 8635572, config
  configs/research/release20260728_dense_tworoom_goal25_dense_checkpoint_individual_levels.yaml.

All three carry native dynamics_flops_total. Every sweep here: goal_offset=25,
horizon 2, budget 50, 100 episodes, 22 CEM cells per run (25-cell
...
K96TO192_SOURCE_DIR = RESEARCH / "release20260728_k96to192_tworoom_goal25_all_fidelity_schedules"
DENSE_LEVELS_SOURCE_DIR = RESEARCH / "release20260728_tworoom_goal25_dense_checkpoint_individual_levels"
