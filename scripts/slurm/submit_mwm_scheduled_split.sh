...
PUSHT_JOB="$(sbatch --parsable scripts/slurm/slurm_mwm_train_pusht_scheduled.sbatch)"
TWOROOM_JOB="$(sbatch --parsable scripts/slurm/slurm_mwm_train_tworoom_scheduled.sbatch)"
BENCHMARK_JOB="$(sbatch --parsable --dependency="afterok:${PUSHT_JOB}:${TWOROOM_JOB}" scripts/slurm/slurm_mwm_scheduled_comparison.sbatch)"
